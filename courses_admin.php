...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="graphic/assets/img/favicon.ico">
                            ...
                            <div class="main-menu d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">                                                                                          
                                        ...
                                        <li><a href="courses_admin.php">Books</a>
                                            <ul class="submenu">
                                                ...
                                                <div class="single-course mb-70">
                                                    ...
                                                    <div class="course-caption">
                                                        <div class="course-cap-top">
                                                            <h4><a href="coursevideo/index.php">Graphic Design</a></h4>
                                                        </div>
