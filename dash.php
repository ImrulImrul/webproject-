  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        </li><li class="pull-right"> <a href="../adminpanel.php"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Back</a></li>
...
<tr style="color:red"><td><b>Rank</b></td><td><b>Name</b></td></td><td><b>Score</b></td></tr>';
$c=0;
...
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Name</b></td></td><td><b>Email</b></td><td><b>Mobile</b></td><td>Action</td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$name = $row['username'];
	$mob = $row['phone'];
