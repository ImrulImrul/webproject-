...
$query = "SELECT * FROM orders ";$result=mysqli_query($conn,$query);
...
<html>
	<head>
		<title>Confirmation Invoice</title>
			...
			<div class="table-responsive">
				...
				foreach($result as $row)
				{
					...
					<tr>
						...
						<td>
						<button type="button" name="email_button" class="btn btn-info btn-xs email_button" id="'.$count.'" data-email="'.$row["email"].'" data-name="'.$row["name"].'" data-action="single">Send Single</button>
						</td>
					</tr>
					';
				}
